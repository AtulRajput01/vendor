...
const ProfilePage = () => {
  ...
  const fetchProfile = async (vendorId) => {
    const response = await axios.get(`http://54.71.141.115:3002/vendor/profile/${vendorId}`);
  ...
  const handleSaveClick = async () => {
    await axios.put(`http://54.71.141.115:3002/vendor/profile/${vendorId}`, profile)
      .then(response => {
  ...
  const handlePasswordSubmit = async () => {
    await axios.put(`http://54.71.141.115:3002/vendor/changePassword/${vendorId}`, passwords)
      .then(response => {
