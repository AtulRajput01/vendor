...
const ProfilePage = () => {
  ...
  const fetchProfile = async (vendorId) => {
    const response = await axios.get(`http://www.taxidermyvendor.hunt30.com/api/vendor/profile/${vendorId}`);
  ...
  const handleSaveClick = async () => {
    await axios.put(`http://www.taxidermyvendor.hunt30.com/api/vendor/profile/${vendorId}`, profile)
      .then(response => {
  ...
  const handlePasswordSubmit = async () => {
    await axios.put(`http://www.taxidermyvendor.hunt30.com/api/vendor/changePassword/${vendorId}`, passwords)
      .then(response => {
